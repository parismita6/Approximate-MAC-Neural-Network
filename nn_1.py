...
def appx_multiplier8x8_tensor(a, b):
    ...
    carry1_ALXL,ALXL_result[7] = binary_addition(ALXL[0][7],ALXL[1][7] , ALXL[2][7] , ALXL[3][7],0)
    _,ALXL_result[6] = binary_addition(ALXL[0][6] ,ALXL[1][6] , ALXL[2][6] , ALXL[3][6],carry1_ALXL)
    ALXL_result[5] = 1
    ALXL_result[4] = 1
    intermediate_carry1 = [0]*3
    intermediate_carry1[0], ALXL_result[3] = binary_addition(ALXL[0][3], ALXL[1][3], ALXL[2][3], ALXL[3][3], carry_in_ALXL)
    ...
    carry1_ALXH, ALXH_result[7] = binary_addition(ALXH[0][7], ALXH[1][7], ALXH[2][7], ALXH[3][7], 0)
    _, ALXH_result[6] = binary_addition(ALXH[0][6], ALXH[1][6], ALXH[2][6], ALXH[3][6], carry1_ALXH)
    ALXH_result[5] = 1
    ALXH_result[4] = 1
    intermediate_carry2 = [0]*3
    intermediate_carry2[0], ALXH_result[3] = binary_addition(ALXH[0][3], ALXH[1][3], ALXH[2][3], ALXH[3][3], carry_in_ALXH)
    ...
    carry1_AHXL, AHXL_result[7] = binary_addition(AHXL[0][7], AHXL[1][7], AHXL[2][7], AHXL[3][7], 0)
    _, AHXL_result[6] = binary_addition(AHXL[0][6], AHXL[1][6], AHXL[2][6], AHXL[3][6], carry1_AHXL)
    AHXL_result[5] = 1
    AHXL_result[4] = 1
    intermediate_carry3 = [0]*3
    intermediate_carry3[0], AHXL_result[3] = binary_addition(AHXL[0][3], AHXL[1][3], AHXL[2][3], AHXL[3][3], carry_in_AHXL)
