...
def appx_multiplier8x8_tensor(a, b):
    ...
    ALXL_result[7] = 0
    ALXL_result[6] = 0
    ALXL_result[5] = ALXL[0][5]| ALXL[1][5]| ALXL[2][5]| ALXL[3][5]
    ALXL_result[4] = ALXL[0][4]| ALXL[1][4]| ALXL[2][4]| ALXL[3][4]
    ...
    ALXH_result[7] = 0
    ALXH_result[6] = 0
    ALXH_result[5] = ALXH[0][5]| ALXH[1][5]| ALXH[2][5]| ALXH[3][5]
    ALXH_result[4] = ALXH[0][4]| ALXH[1][4]| ALXH[2][4]| ALXH[3][4]
    ...
    AHXL_result[7] = 0
    AHXL_result[6] = 0
    AHXL_result[5] = AHXL[0][5]| AHXL[1][5]| AHXL[2][5]| AHXL[3][5]
    AHXL_result[4] = AHXL[0][4]| AHXL[1][4]| AHXL[2][4]| AHXL[3][4]
